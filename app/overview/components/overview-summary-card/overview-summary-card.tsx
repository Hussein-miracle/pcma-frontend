...
const OverviewSummaryCard = ({
  ...
  return (
    <div className="w-full rounded-xl pt-3 px-3 pb-6 bg-white border-[#0074FF0D] border-2 border-solid h-full flex flex-col gap-2 items-center justify-between ">
      <div className="w-full self-start flex-col items-start sm:flex-row sm:items-center  gap-4 sm:gap-2">
        {icon}
        <span className=" capitalize text-base/6 font-normal tracking-[1%] text-secondary-black sm:whitespace-pre whitespace-break-spaces">
          {title}
        </span>
      </div>
